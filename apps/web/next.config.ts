...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "connect-src 'self' https://tpembd.com https://*.travelpayouts.com https://*.aviasales.com https://avsplow.com https://*.avsplow.com",
      "frame-src https://tpembd.com https://*.travelpayouts.com https://*.aviasales.com https://avsplow.com https://*.avsplow.com",
